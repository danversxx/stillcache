      ...
      <div className="w-full px-[18px] sm:px-[24px] md:px-[clamp(44px,calc(13.2vw-20px),240px)]">
        <div className="mx-auto w-full max-w-[clamp(1060px,68vw,1280px)]">
          ...
          <header className="pt-[20px] md:pt-[64px] pb-[20px] md:pb-[32px]">
            <div className="text-[20px] md:text-[28px] font-bold tracking-[-0.02em] leading-[26px] md:leading-[34px]">
              Still Cache
            </div>
          </header>
          ...
          <div className="flex flex-col gap-[24px] md:gap-[32px] pt-[80px] md:pt-[120px] pb-[64px]">
            ...
            <div className="flex items-center gap-[12px]">
              ...
              <a href="/" className="film-trailer-cta inline-flex items-center justify-center px-[14px] font-bold text-[12px] md:text-[14px] leading-[18px] md:leading-[20px] tracking-[0.01em]">
                Home
              </a>
            </div>
          </div>
